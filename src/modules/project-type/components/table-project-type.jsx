...
export const TableProjectType = () => {
  ...
  const total = useSelector(state => state.projectType.total);
    ...
    <div className="h-96 sm:w-full">
      {loading ? (
        ...
        <div className="sm:w-full sm:flex sm:flex-col sm:items-center">
          ...
          <table 
            id="myTable" 
            className="flex-col shadow-xl flex justify-center sm:w-11/12 bg-white w-11/12 rounded-xl table-list"
