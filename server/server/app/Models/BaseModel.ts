...
class BaseModel extends Base {
  ...
  static async insertOneIgnore<T extends BaseModel>(this: new() => T, object, ignoreColumn): Promise<T> {
    return await (this as any).query().insert(object).onConflict(ignoreColumn).ignore();
  }
