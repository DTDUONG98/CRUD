...
class GridTable extends React.Component {
    ...
    return {
      filterDropdown: ({ confirm, setSelectedKeys }) => {
        ...
        let confirmFnc = (values) => {
          let currentColumn = this.columns.find(
  ...
  init() {
    ...
    this.pagination = {
      pageSize: defaultOptions.pageSize || 5,
  ...
  getPagination = (pagination) => {
    ...
    return {
      ...
      showTotal: () => `Total ${this.total} records`,
      pageSizeOptions: ["2", "5", "10", "50", "100", "200", "500"],
    };
  };
  ...
  render() {
    ...
    const { page = 0, pageSize = 5 } = this.pagination || {};
    return (
      <div>
        <Table
          {...this.initialProps}
