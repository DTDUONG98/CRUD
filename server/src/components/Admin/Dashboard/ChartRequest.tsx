...
const ChartRequest = () => {
  ...
  let requests = data.map(item => ({ t: item.t, y: item.y.request, format: item.format }))
  let numbers = data.map(item => ({ t: item.t, y: item.y.numbers, format: item.format }))
